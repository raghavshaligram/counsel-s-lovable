...
const FAQS = [
  {
    ...
    a: "Nowhere. PDFMacro runs entirely in your browser tab using WebAssembly. There is no upload endpoint. Open your browser's Network tab while you work — you'll see zero file uploads. The processing happens on your CPU, the result is written back as a download.",
  },
  {
  ...
  },
  {
    ...
    a: "Yes — because your file never leaves your device, none of those regulations are triggered by PDFMacro. There's no data processor agreement to sign, no breach to report, no cloud subprocessor to vet. We literally cannot see your file.",
  },
  {
...
export const Route = createFileRoute("/pricing")({
  head: () => ({
    meta: [
      { title: "Pricing — PDFMacro Lifetime Deal" },
      {
        name: "description",
        content:
          "One payment, every tool, forever. The PDFMacro AppSumo lifetime deal — join the waitlist for launch pricing.",
      },
      { property: "og:title", content: "PDFMacro — Lifetime Deal" },
      {
    ...
    scripts: [
      ...
      },
      {
        ...
        children: JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Product",
          name: "PDFMacro Lifetime License",
          description:
            "One-time payment for lifetime access to every PDFMacro tool, current and future.",
          brand: { "@type": "Brand", name: "PDFMacro" },
          offers: {
            "@type": "Offer",
      ...
      <section className="relative overflow-hidden border-b border-border">
        ...
        <div className="relative mx-auto max-w-5xl px-5 md:px-8 pt-16 md:pt-24 pb-12 md:pb-16 text-center">
          ...
          <p className="mt-7 max-w-2xl mx-auto text-lg text-muted-foreground leading-relaxed">
            PDFMacro runs entirely in your browser, so we don't pay for servers — which means we
        ...
        <div className="mx-auto max-w-5xl px-5 md:px-8 py-16 md:py-20 grid lg:grid-cols-[1.1fr_1fr] gap-8 items-start">
          ...
          <div className="space-y-6">
            ...
            <div className="rounded-xl border border-border bg-card/40 p-5">
              ...
              <CostRow name="PDFMacro Lifetime" price="$59 once" total="$59" good />
            </div>
            <div className="rounded-xl border border-border bg-card/40 p-5 text-sm text-muted-foreground leading-relaxed">
              ...
              PDFMacro runs on your CPU — no servers, no recurring cost on our side, so no
