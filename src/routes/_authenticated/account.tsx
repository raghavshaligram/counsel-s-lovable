...
export const Route = createFileRoute("/_authenticated/account")({
  head: () => ({
    meta: [
      { title: "Account settings — VaultPDF" },
...
function ProfileCard({ profile, onSaved }: { profile: { fullName: string }; onSaved: () => void }) {
  ...
  return (
    <Card title="Profile" icon={<UserIcon className="h-3.5 w-3.5" />} description="How VaultPDF addresses you.">
    ...
    <section className="rounded-md border border-destructive/40 bg-destructive/[0.04] p-5">
      <div className="flex items-start gap-3">
        ...
        <div className="min-w-0">
          ...
          <p className="mt-0.5 text-[12px] text-text-2">Deleting your account cancels your subscription and removes your identity from VaultPDF. Documents you exported stay on your device.</p>
        </div>
      </div>
      {!open ? (
