...
export const Route = createFileRoute("/editor")({
  head: () => ({
    meta: [
      { title: "PDF Editor — annotate, edit text, reorder pages | PDFMacro" },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "PDF Editor — PDFMacro" },
...
function PageCanvas({
  ...
  const cursorByTool: Record<Tool, string> = {
    ...
    freehand: "crosshair", note: "copy", image: "copy", "edit-text": "pointer", "page-crop": "crosshair", redact: "crosshair",
  };
