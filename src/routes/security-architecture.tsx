...
export const Route = createFileRoute("/security-architecture")({
  head: () => ({
    meta: [
      { title: "Security & Architecture — PDFMacro" },
      {
        name: "description",
        content:
          "Technical overview of PDFMacro's client-side architecture for law firm IT and compliance reviewers. No server receives document content.",
      },
      { property: "og:title", content: "Security & Architecture — PDFMacro" },
      {
          ...
          <div className="grid lg:grid-cols-[1fr_1.2fr] gap-12 lg:gap-16 items-start">
            <div>
              ...
              <p className="mt-6 text-muted-foreground leading-relaxed">
                When you open a PDF in PDFMacro, the file is read into browser memory as a
            ...
            <div className="space-y-4">
              <DetailRow
                ...
                value="PDFMacro is deployed as a static site. There is no /upload, /process, or /convert endpoint. The server serves HTML, JavaScript, and WASM bundles only."
              />
              <DetailRow
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="mt-2 text-sm text-muted-foreground leading-relaxed">
                  PDFMacro maintains two IndexedDB databases on the device:
                  <code className="text-xs bg-accent-soft px-1.5 py-0.5 rounded text-foreground mx-1">pdfmacro-workspace</code>
                  stores UI state, recent document bytes (capped at 120 MB total), per-document
                  annotation sidecars, and user bookmarks; and
                  <code className="text-xs bg-accent-soft px-1.5 py-0.5 rounded text-foreground mx-1">pdfmacro-tray</code>
          ...
          <div className="grid md:grid-cols-2 gap-10">
            <div className="rounded-xl border border-border bg-card/40 p-6 md:p-8">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                PDFMacro registers a Service Worker that precaches the application shell and
            ...
            <div className="rounded-xl border border-border bg-card/40 p-6 md:p-8">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                Because no step requires a network round-trip, PDFMacro can be used on machines
          ...
          <div className="mt-12 rounded-xl border border-vault/20 bg-accent-soft p-6 md:p-8">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="mt-2 text-sm text-muted-foreground leading-relaxed">
                  PDFMacro does not collect, process, or store your documents on our infrastructure.
