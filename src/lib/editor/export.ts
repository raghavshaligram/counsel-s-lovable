...
import type {
  Anno, EditorDoc, ExportSettings, HeaderFooterSettings, PageNumberSettings,
  PageOp, RGB, WatermarkSettings,
} from "./types";
...
function formatPageNumber(n: number, total: number, fmt: PageNumberSettings["format"]): string {
  switch (fmt) {
